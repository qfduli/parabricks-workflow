...
class pangenomeAwareDeepvariantOptionGenerator():
    def __init__(self, is_pipeline=False, is_denovomutation=False, is_pacbio_germline=False):
        self.allOptions = [
            ...
            PBOption(category="deepvariantOption", name="--mode", default="shortread", helpStr="Value can be one of [shortread]. By default, it is shortread."),
            ...
            PBOption(category="deepvariantOption", name="--sample-name-pangenome", typeName=str, default="pangenome", helpStr="Sample name to use for pangenome data. Default is 'pangenome'."),
            PBOption(category="deepvariantOption", name="--ref-name-pangenome", typeName=str, default="GRCh38", helpStr="Reference genome name for pangenome data. Default is 'GRCh38'."),
        ]
        self.perfOptions = [
